SELECT subset.*,   
    ...
    LEFT JOIN pluto_18v1 pluto on viols.bbl = pluto.bbl
...
group by subset.bbl, subset.cd, subset.address, residentialunits, uc2007, uc2016, class_a, class_b, class_c, total, subset.borocode, subset.block, subset.lot, hpdlink, subset.council, subset.zipcode
