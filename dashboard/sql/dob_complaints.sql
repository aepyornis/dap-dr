...
group by subset.bbl, subset.address, communityboard, residentialunits, uc2007, uc2016, dobcomplaints, subset.borocode, subset.block, subset.lot, hpdlink, subset.council, subset.zipcode
