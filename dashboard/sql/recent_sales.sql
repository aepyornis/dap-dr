...
select subset.*,
	...
	WHERE pluto.cd is not null
      ...
      AND COALESCE(uc2007,uc2008, uc2009, uc2010, uc2011, uc2012, uc2013, uc2014,uc2015,uc2016,uc2017,uc2018) is not null
        group by sales.bbl, pluto.cd, pluto.address, pluto.unitsres, uc2007, uc2018, borocode, pluto.block, pluto.lot, pluto.council, pluto.zipcode, pluto.bbl
      ) as subset
...
group by subset.bbl, subset.cd, subset.address, residentialunits, uc2007, uc2018, subset.borocode, subset.block, subset.lot, subset.zipcode, subset.council, subset.saleprice, ppgsf, ppu, subset.saledate, hpdlink
