select subset.*,
      ...
      group by hpd.bbl, pluto.cd, pluto.address, residentialunits, receiveddate, uc2007, uc2016, borocode, pluto.block, pluto.lot
...
group by subset.bbl, cd, address, residentialunits, uc2007, uc2016, hpdcomplaints, borocode, hpdlink, bislink, acrislink
