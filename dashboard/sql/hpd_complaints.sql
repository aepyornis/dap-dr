select subset.*,
      ...
      left join pluto_18v1 pluto on pluto.bbl=hpd.bbl
...
group by subset.bbl, subset.cd, subset.address, residentialunits, uc2007, uc2016, hpdcomplaints, subset.borocode, subset.block, subset.lot, hpdlink, subset.council, subset.zipcode
