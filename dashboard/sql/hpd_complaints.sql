select subset.*,
      ...
      group by hpd.bbl, pluto.cd, pluto.address, residentialunits, uc2007, uc2017, borocode, pluto.block, pluto.lot, pluto.council, pluto.zipcode, pluto.bbl
...
group by subset.bbl, subset.cd, subset.address, residentialunits, uc2007, uc2017, hpdcomplaints, subset.borocode, subset.block, subset.lot, hpdlink, subset.council, subset.zipcode
