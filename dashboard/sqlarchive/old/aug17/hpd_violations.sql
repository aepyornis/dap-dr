SELECT subset.*,   
    ...
    WHERE
       pluto.cd = '${ cd }' 
	   and novissueddate between '08-01-2017' and '08-31-2017'
...
group by subset.bbl, cd, address, residentialunits, uc2007, uc2016, class_a, class_b, class_c, total, borocode, hpdlink, bislink, acrislink, googlelink, taxlink, oasislink, council, zipcode
